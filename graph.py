class Graph:
    ...
    make a graph data structure in an efficient way which enables an a traversal to find the shortest path given that a friend
    ...
    def __init__(self, roads, tracks, friends) -> None:
        """
        Function description: Initializes the graph with roads, tracks, and friends data. It constructs the road graph
    ...
    def add_friend_locations(self) -> None:
        ...
        Time Complexity Analysis:
            - O(|F|) to assign each friend to their starting location.
            - O(|T|) to iterate over all tracks and update train hops.
